...
class Arrivals extends Flights{
    ...
    function __construct($flight_id, $time, $origin,$airline,$status,$date,$id_arrival,$takeoff_time){
        Flights::__construct($flight_id, $time, $origin,"Kosovo",$airline,$status,$date);
